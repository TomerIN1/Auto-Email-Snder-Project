...
#os.environ['SNOWFLAKE_ACCOUNT'] = 'xxxx'
#os.environ['SNOWFLAKE_USER'] = 'xxxx'
#os.environ['SNOWFLAKE_PASSWORD']='xxxx'
#os.environ['SNOWFLAKE_DATABASE'] = 'xxxx'
#os.environ['SNOWFLAKE_DATAWAREHOUSE'] = 'xxxx'

#Email environment variables
#os.environ['EMAIL_SMTP_SERVER'] = 'xxxx'
#os.environ['EMAIL_SMTP_PORT'] = 'xxxx'
#os.environ['EMAIL_SENDER'] = 'xxxx'
#os.environ['EMAIL_PASSWORD'] = 'xxxx'
...
def main_query():
    return '''
        ...
        WHERE A.CONTRACT_ACTIVITY_STATUS IN ('xxxx', 'xxxx')
        AND B.CONTRACT_MODEL_TYPE = 'xxxx'
        AND DATE(A.CONTRACT_CREATION_DATE) >= xxxx
        AND A.LAST_PAYMENT_DATE IS NOT NULL
        AND B.CONTRACT_GENERATION = 'xxxx'
        AND A.PARTNER_KEY = 'xxxx'
...
def mail_sender():
    ...
    if data_relevant:
        ...
        #CREATE DATA FRAME
        df_daily_status = pd.read_sql_query(main_query(),engine)
